...
import FAQImage1 from '@/assets/FAQImage1.png'; // Replace with your actual image path
...
export default function FAQComponent() {
    ...
    return (
        <div className="flex flex-col mx-auto px-10 py-12 bg-white min-h-screen">
            <h2 className="text-4xl font-semibold:600 text-black mb-4 text-center">Diet Related Questions</h2>
            <div className="flex flex-col md:flex-row justify-between items-start">
                <div className="w-full md:w-1/2 flex justify-center items-center order-1 md:order-1">
                    <div className="relative w-full h-96 flex justify-center items-center">
                        <div className="relative w-full h-full">
                            <Image src={FAQImage1} alt="FAQ" layout="fill" objectFit="contain" />
                        </div>
                    </div>
                </div>
