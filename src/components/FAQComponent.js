...
import FAQImage from '@/assets/FAQImage.png'; // Replace with your actual image path
...
export default function FAQComponent() {
    ...
    return (
        <div className="flex flex-col mx-auto px-10 py-12 bg-white min-h-screen">
            <h2 className="text-4xl font-bold:600 text-black mb-4 text-center">General Questions</h2>
            <div className="flex flex-col md:flex-row justify-between items-start">
                    ...
                    <div className="space-y-2">
                        {questions.map((question, index) => (
                            <div key={index} >
                                ...
                                >
                                    <div className={`pl-6 pb-4 text-base text-gray-700 border-black border-b ${activeIndex === index ? 'animate-top-down-bump' : ''}`}>
                ...
                <div className="w-full md:w-1/2 mt-8 md:mt-0 flex justify-center items-center">
                    <div className="relative w-full h-96">
                        <Image src={FAQImage} alt="FAQ" layout="fill" objectFit="contain" />
                    </div>
                </div>
            </div>
        </div>
